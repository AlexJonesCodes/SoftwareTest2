...
This project uses GitLab CI to build Docker images, start the application and MongoDB via Docker Compose, run the Jest test suite inside a dedicated test container, and publish coverage info. A lot of this has already been partially set up.
...
4. **test**
   ...
   - Jest coverage outputted to the CI workspace as artifacts.
...
- Coverage is collected automatically by Jest in `jest.config.js` and exported as pipeline information/artifacts.

## How to see the pipeline work
